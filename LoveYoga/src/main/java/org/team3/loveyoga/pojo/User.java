...
public class User {
	...
	public User(Integer yu_id, String yu_tel, String yu_password, String yu_name, String yu_email, Integer yu_rid,
			Integer flag) {
		super();
		this.yu_id = yu_id;
		this.yu_tel = yu_tel;
	...
	public String toString() {
		return "User [yu_id=" + yu_id + ", yu_tel=" + yu_tel + ", yu_password=" + yu_password + ", yu_name=" + yu_name
