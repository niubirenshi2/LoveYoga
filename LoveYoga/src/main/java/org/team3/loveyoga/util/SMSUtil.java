...
public class SMSUtil {
    ...
    // 配置个人阿里云的AK，保密信息
    private static String accessKeyId = "LTAIp8aF35ToYXZ6";
    
    private static String accessKeySecret = "dOcPRJFYhI61fWLvsXeFwHy8GH2psX";

    //默认的超时时间，分为连接超时和读取超时
    private static String defaultConnectTimeout = "60000";
    private static String defaultReadTimeout = "60000";

    //发送验证码短信的配置信息
    private static String signName = "蜗牛学院瑜伽APP";
    private static String templateCode = "SMS_168305264";
